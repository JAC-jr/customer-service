package com.example.CustomerSE.controller;




        import com.example.CustomerSE.service.CustomerService;
...
public class CustomerRestController {
    ...
    public ResponseEntity<Customer> deleteCustomer(@PathVariable("numberID") long id) {
